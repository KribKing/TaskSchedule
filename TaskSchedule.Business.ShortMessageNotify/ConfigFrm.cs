...
using TaskSchedule.Business.ShortMessageNotify;
...
namespace TaskSchedule.Business.ShortMessageNotify
{
    ...
    {
        private JobInfoShortMessage Cur_JobInfo = new JobInfoShortMessage();
        public ConfigFrm()
        {
            InitializeComponent();
        }
        ...
        {
            InitializeComponent();
            this.Cur_JobInfo = info as JobInfoShortMessage;
        }
        ...
        private void ConfigFrm_Load(object sender, EventArgs e)
        {
            if (this.Cur_JobInfo != null)
            {
                ...
                this.tesystem.Properties.ReadOnly = true;
                this.tesysname.Properties.ReadOnly = true;
            }
        }
