    ...
    public class ParamJob : IJob
    {
        public void Execute(IJobExecutionContext context)
        {
            ...
            try
            {
                ...
                string requeststr = new RequestMessage() { Request = new Request() { Head = new Head() { TranCode = jobinfo.id, TranName = jobinfo.name, TranSys = jobinfo.system, TranSysName = jobinfo.sysname }, Body = strrequest } }.ToString();
