...
namespace DownLoad.UI
{
    public partial class JsonFrm : FrmBase
    {
        ...
        private void backgroundWorker1_ProgressChanged(object sender, ProgressChangedEventArgs e)
        {
            ...
            {
                ProcessBarFrm.Instance.ProcessCommand(DownLoad.Core.ProcessBarFrm.SplashScreenCommand.processvalue, e.ProgressPercentage.ToString());
                string showtxt = "";
                ...
                ProcessBarFrm.Instance.ProcessCommand(DownLoad.Core.ProcessBarFrm.SplashScreenCommand.notify, showtxt);
